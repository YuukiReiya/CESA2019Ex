...
namespace GamePadInput
{
    ...
    public class GamePadController : MonoBehaviour
    {
        ...
        */
        public bool LT
        {
            get { return GamePad.GetTrigger(Controller, GamePad.Trigger.LEFT) > _dead_; }
        }

        public bool RT
        {
            get { return GamePad.GetTrigger(Controller, GamePad.Trigger.RIGHT) < _dead_; }
        }
